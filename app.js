...
// Config
r.get('/common/config', getConfig);
r.get('/common/cta-offer', getCTAOffer);
r.get('/common/stripe-key', getStripeKey);
r.get('/common/social-keys', getSocialKeys);
...
// Logs
r.get('/common/logs', handleLogs);
r.post('/common/logs', handleLogs);
